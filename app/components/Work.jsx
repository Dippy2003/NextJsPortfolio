...
const Work = ({isDarkMode}) => {
 ...
 transition={{duration:0.3}}
          ...
          >
            ...
            <div 
              className="
                bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 
            ...
            >
              ...
              <div 
                className="
                  border rounded-full border-black w-9 aspect-square 
      ...
      href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover hover:shadow-md hover:-translate-y-1 duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
        Show more <Image src={isDarkMode ? assets.right_arrow_bold_dark: assets.right_arrow_bold} alt="right arrow" className="w-4 inline-block ml-2"/>
      </motion.a>
