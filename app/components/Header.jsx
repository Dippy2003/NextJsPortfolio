  ...
  return (
   <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 pt-32'>
    ...
    className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'
             >Hi! I'm Dipna Wijesinghe <Image src={assets.hand_icon} alt='' className='w-6'/> </motion.h3>
             <motion.h1 
        ...
        transition={{duration:0.6 ,delay:1.2}}
                ...
                href='/sam.pdf' download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>Download
